  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center px-6">
      <div className="max-w-4xl w-full">
        <h1 className="text-6xl md:text-7xl font-bold mb-6 animate-fade-in">Michele F. Matozza</h1>
        <p
          className="text-xl text-muted-foreground mb-8 max-w-3xl leading-relaxed animate-fade-in"
